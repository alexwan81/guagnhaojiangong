...
// @ts-ignore;
import { ArrowLeft, PlayCircle, BookOpen, Clock, FileText } from 'lucide-react';
  ...
  return <div style={style} className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pb-16">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="space-y-6">
          {chapters.map(chapter => <div key={chapter.id} className="bg-white rounded-lg shadow-md p-6">
              {/* 章节标题 */}
              ...
              <div className="space-y-3">
                {chapter.subchapters.map(subchapter => <div key={subchapter.id} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-gray-500 mt-1 ml-16">
                    ...
                    {/* 学习按钮 */}
                    <button onClick={e => handleStudyClick(chapter.id, subchapter.id, subchapter.title, e)} className="bg-blue-600 text-white px-4 py-2 rounded-md text-sm hover:bg-blue-700 transition-colors flex items-center whitespace-nowrap ml-4">
